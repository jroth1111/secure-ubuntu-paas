...
test-lint-docker: docker-build-tier1
	$(RUNNER_DOCKER_CMD) \
	  ...
	  --cmd 'bash -n base/bootstrap.sh base/validate.sh setup.sh deploy.sh overlays/coolify/configure_coolify_binding.sh overlays/coolify/coolify-common.sh lib/common.sh lib/tailscale.sh && shellcheck -S error base/bootstrap.sh base/validate.sh setup.sh deploy.sh overlays/coolify/configure_coolify_binding.sh overlays/coolify/coolify-common.sh lib/common.sh lib/tailscale.sh scripts/*.sh'
